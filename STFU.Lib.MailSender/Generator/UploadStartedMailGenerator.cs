...
{
	public class UploadStartedMailGenerator : IMailGenerator
	{
...
<body style=""padding: 0; margin:0;"">
	<div
		style=""padding: 0; margin:0; width: calc(100% - 4rem); background: #CFF; margin: 0; padding: 2rem; left: 0; top: 0;"">
		<table>
			<tr>
				<td>
	...
	<div style=""padding: 1rem;"">
		<p>Hallo {1},</p>
		<p>Dein Video <strong>{0}</strong> wird nun mit folgenden Einstellungen auf Youtube hochgeladen: </p>
