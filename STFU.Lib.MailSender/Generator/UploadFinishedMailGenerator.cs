...
{
	public class UploadFinishedMailGenerator : IMailGenerator
	{
...
<body style=""padding: 0; margin:0;"">
	<div
		style=""padding: 0; margin:0; width: calc(100% - 4rem); background: #CFC; margin: 0; padding: 2rem; left: 0; top: 0;"">
		<table>
			<tr>
				<td>
	...
	<div style=""padding: 1rem;"">
		<p>Hallo {1},</p>
		<p>Dein Video <strong>{0}</strong> wurde erfolgreich auf Youtube hochgeladen!</p>
		<p>Es steht dort nun mit folgenden Einstellungen zur Verf&uuml;gung:</p>
